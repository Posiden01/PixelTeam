    ...
    return (
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          <div
            key={i}
            className="w-full py-4 space-y-2 lg:py-0 relative cursor-pointer rounded-xl border border-white/20 h-fit lg:h-20 px-4 lg:px-10 flex flex-wrap lg:flex-nowrap items-center justify-between"
          >
            {!is_loaded && (
            ...
            {action.is_error ? (
              ...
              <div className="text-muted-foreground text-md flex items-center gap-4">
                ...
                <Select
                  ...
                  value={selcted}
                >
                  <SelectTrigger className="w-32 outline-none border-white/20 focus:outline-none focus:ring-0 text-center text-muted-foreground bg-background text-md font-medium">
                    <SelectValue placeholder="..." />
                  </SelectTrigger>
                  <SelectContent className="h-fit border-white/20 backdrop-blur-md">
